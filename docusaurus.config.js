...
const config = {
  ...
  baseUrl: '/easyquery/docs/api-reference',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'Korzh.com', // Usually your GitHub org/user name.
  projectName: 'EasyQuery API Docs', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      image: 'img/korzh-docs-social-card.jpg',
      navbar: {
        title: '',
        logo: {
          alt: 'My Site Logo',
        ...
        items: [
          ...
          {
            href: 'https://github.com/olton/EasyQueryAPIDocs',
            label: 'GitHub',
            position: 'right',
          },
        ],
